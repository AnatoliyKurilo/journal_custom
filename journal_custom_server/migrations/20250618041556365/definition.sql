...
--
-- Class ClassTypes as table class_types
--
...
--
-- Class Classes as table classes
--
CREATE TABLE "classes" (
    ...
    "topic" text,
    "notes" text,
    "isClosedByTeacher" boolean,
    "closedAt" timestamp without time zone,
    "closedByTeacherId" bigint
);

--
-- Class Groups as table groups
--
CREATE TABLE "groups" (
    "id" bigserial PRIMARY KEY,
    "name" text NOT NULL,
    "curatorId" bigint,
    "_teachersGroupsTeachersId" bigint
);
...
--
-- Class Semesters as table semesters
--
...
--
-- Class StudentSubgroup as table student_subgroups
--
...
--
-- Class Students as table students
--
...
--
-- Class Subgroups as table subgroups
--
...
--
-- Class Teachers as table teachers
--
...
--
-- Foreign relations for "classes" table
--
...
--
-- Foreign relations for "groups" table
--
...
--
-- Foreign relations for "student_subgroups" table
--
...
--
-- Foreign relations for "subgroups" table
--
...
--
-- Foreign relations for "teachers" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('journal_custom', '20250618041556365', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250618041556365', "timestamp" = now();
